...
public class PartialUpdateAuthorRequestValidator : AbstractValidator<PartialUpdateAuthorRequest>
{
    private readonly ICountryService _countryService;
    private readonly IBookService _bookService;
    public PartialUpdateAuthorRequestValidator(ICountryService countryService, IBookService bookService)
    {
        _countryService = countryService;
        _bookService = bookService;
        When(a => a.FirstName != null, () =>
        {
